                    ...
                    default:
                        {
                            ...
                            re_compiled[j].ch_ccl.ch = pattern[i];
                        }
        ...
        case '[':
            {
                ...
                re_compiled[j].ch_ccl.ccl = &ccl_buf[buf_begin];
            }
...
static int matchone ( regex_t p, char c )
{
    ...
    case CHAR_CLASS:
        return  matchcharclass ( c, ( const char* ) p.ch_ccl.ccl );
